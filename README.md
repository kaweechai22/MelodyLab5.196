# MelodyLab v5.114 Speed of Sound Extra Slow Motion
...
## v5.114 Speed of Sound Extra Slow Motion
...
- คงการขยายกราฟแนวตั้งและการปรับความถี่ f จาก v5.114
...
- คงหน้า Displacement and Pressure จาก v5.114
...
## v5.114 Speed of Sound Extra Slow Motion
- ปรับพัลส์เสียงให้ช้าลงกว่ารอบ v5.114
...
- คงเมนู Wave Visualizer 21 หัวข้อจาก v5.114
...
- คงเมนู 21 หัวข้อและ runtime fix จาก v5.114
...
- เพิ่มสูตร Doppler สำหรับผู้สังเกตนิ่ง:
  - ด้านหน้า: f′ = f v/(v−vₛ)
  - ด้านหลัง: f′ = f v/(v+vₛ)
- คง 4 หน้าแรกและ template ของ v5.114
...
- คงหน้า HTML/เมนู/หัวข้อ 5–21 จาก v5.114
...
## v5.114 Echo Threshold Complete
